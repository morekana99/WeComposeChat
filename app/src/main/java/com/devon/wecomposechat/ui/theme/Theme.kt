...
@Composable
fun  WeComposeChatTheme(theme: WeComposeChatTheme.Theme = WeComposeChatTheme.Theme.Light, content: @Composable() () -> Unit) {
  val targetColors = when (theme) {
    WeComposeChatTheme.Theme.Light -> LightColorPalette
    WeComposeChatTheme.Theme.Dark -> DarkColorPalette
    WeComposeChatTheme.Theme.NewYear -> NewYearColorPalette
  }
